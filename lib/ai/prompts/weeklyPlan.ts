...
Formats available: static, reel, story`
...
Choose the best-fit primary platform per post from the active platforms list. Set cross_post_platforms to include all active platforms that make sense for that format (reels for Instagram/TikTok, static+longer captions for Facebook, etc).
